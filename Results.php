            ...
            <div class="col-10  h-100 mid-col" style="margin-top:59px">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        $sql = "SELECT Id, code, 7th, 12th, work, name,final FROM res WHERE id='{$_SESSION['userID']}' ";
                        ...
                        if ($result) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<table style=\"text-align: center; width: 100%;  background-color:#e5e8ef; border-radius: 10px;  margin-bottom:10px;\">
                <tbody>
                    <tr>
                        <th colspan=\"3\">NE 466 <br>$field6</th>
                        <th rowspan=\"2\">$field4</th>
                    </tr>
                    <tr>
                        <td> $field2 <br> 7th Week</td>
                        <td>$field3  <br> 12th Week</td>
                        <td>$field5 <br> Course Work</td>
                    </tr>
                </tbody>
            </table>";
                            }
